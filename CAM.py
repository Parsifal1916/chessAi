...
for index, item in enumerate(tqdm(range(samples), desc=f"[ + ] Getting stockfish predictions")): predictions.append(stockfish.analyse(boards[index], chess.engine.Limit(time=2.0))['score'].relative.score())
